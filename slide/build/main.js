...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SlideView = __webpack_require__(161);
	var Car = __webpack_require__(162);
	...
	var SlideView = React.createClass({
	  ...
	  */
		render: function render() {
			...
			return React.createElement(
				'div',
				{ className: this.props.className || 'slider', style: {
						position: 'absolute',
						top: '0px',
						left: '0px',
						width: '100%',
				...
				this.props.children.map(function (item, i) {
					return React.createElement(
						SlideItem,
						{ transform: 'translateX(' + i * offsetX + 'px)', key: i },
						item
					);
				})
			);
